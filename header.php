        ...
        <div class="col_half fright col_last nobottommargin">
          ...
          <div id="top-social">
            <ul>
              ...
              ?>
                <li>
                  <a href="https://facebook.com/<?php echo get_theme_mod('ju_twitter_handle') ?>" class="si-twitter">
              ...
              ?>
                <li>
                  <a href="https://facebook.com/<?php echo get_theme_mod('ju_instagram_handle') ?>" class="si-instagram">
                    <span class="ts-icon"><i class="icon-instagram2"></i></span><span class="ts-text">Instagram</span>
                  </a>
                </li>
              <?php
              }
              if (get_theme_mod('ju_phone')) {
              ?>
                <li>
                  <a href="tel:<?php echo get_theme_mod('ju_phone') ?>" class="si-call">
                    <span class="ts-icon"><i class="icon-call"></i></span><span class="ts-text"><?php echo get_theme_mod('ju_phone') ?></span>
                  </a>
                </li>
              <?php
              }
      ...
      <div class="container clearfix">
        ...
        <div class="top-advert">
          ...
          if (function_exists('quads_ad')) {
            echo quads_ad(array('location' => 'julia_header'));
          }
          ...
          <div class="container clearfix">
            ...
            <div id="top-search">
              ...
              <form action="<?php echo esc_url(home_url('/')); ?>" method="get">
                <input type="text" name="s" class="form-control" placeholder="<?php _e('Type &amp; Hit Enter..', 'julia'); ?>" />
